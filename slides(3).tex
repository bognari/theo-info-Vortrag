...
%
%     Es gibt also zu jeder Funktion Slice-Funktionen, wenn diese Funktionen einen Wahr(1) generieren obwohl nicht alle Eingangswerte Wahr waren.
%     Diese Anzahl an eingangs Wahrs bilden das $k \in \mathbb{N}$.
%     Somit kann man den SC in kleinere SCs teilen, die auch immer f\"ur die noch enthaltenen Eing\"ange definiert ist.
%     Warum man so etwas macht erkl\"aren wir sp\"ater.
%
