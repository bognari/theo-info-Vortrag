...
\begin{document}
  ...
  \subsection{Ordnungsfunktions-Beispiele ($\leq$)}
  \subsubsection*{Ordnungsfunktions Beispiel der Tupel mit n = 1}
  \begin{frame}
    \begin{figure}
  ...
  \subsubsection*{Ordnungsfunktions Beispiel der Tupel mit n = 2}
  \begin{frame}
    \begin{figure}
  ...
  \subsubsection*{Ordnungsfunktions Beispiel der Tupel mit n = 3}
  \begin{frame}
    \begin{figure}
  ...
  \subsubsection*{Ordnungsfunktions Beispiel der Tupel mit n = 4}
  \begin{frame}
    \begin{figure}
  ...
  \begin{frame}
    ...
    \begin{itemize}
      ...
      \item $S(f)$ bestimmt den kleinstmöglichen Schaltkreis für $f(x)$
      \item $C_M(f) = min \{G(S_M(f))\}$
      \item $S_M(f)$ bestimmt den kleinstmöglichen monotonen Schaltkreis
    \end{itemize}
  \end{frame}
